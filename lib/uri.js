 ...
 * ```javascript
 *
 * var uri = new URI('saga:shKuYvckNtXUeCxcEHDaKiGBd5BDvGfwsq?amount=1.2');
 ...
 * ```javascript
 *
 * var valid = URI.isValid('saga:shKuYvckNtXUeCxcEHDaKiGBd5BDvGfwsq');
 * // true
 * ```
 *
 * @param {string|Object} data - A bitcoin URI string or an Object
...
URI.parse = function(uri) {
  ...
  if (info.protocol !== 'saga:') {
    throw new TypeError('Invalid saga URI');
  }
...
URI.prototype._fromObject = function(obj) {
  ...
  if (!Address.isValid(obj.address)) {
    throw new TypeError('Invalid saga address');
  }
